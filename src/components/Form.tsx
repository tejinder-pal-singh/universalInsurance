...
export const Form = ({ type }: { type: Email['type'] }) => {
	const sendMail = (userEmail, subject, msg) => {
		const config = {
			SecureToken: '68e84eee-0be4-4b74-82b9-ee323757b354',
			// SecureToken: '0450a839-2b6c-4184-9964-46884e54ebe3',
			To: 'mr.aashat@gmail.com',
			From: 'universalinsured@gmail.com',
			Subject: subject,
			Body: msg,
		};
		if (window.Email) {
		...
		<div className='p-4 py-6 rounded-lg bg-white  md:p-8'>
			<Formik
				...
				onSubmit={(
					...
					sendMail(values.email, values.subject, values.message);
					// setTimeout(() => {

...
function Wordings({ big, small }: { big: string; small: string }) {
	return (
		<div
			...
			<div variants={spanWordings} className='text-lg'>
				{small}
			</div>
		</div>
	);
...
export const Banner = () => {
	return (
		<div className='lg:px-32  px-10 py-5 z-30 overflow-x-auto  gap-5 bg-white  w-full flex items-center justify-between home-stats-section'>

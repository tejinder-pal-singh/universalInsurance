						...
						<div className='col-span-3 text-2xl'>
							<div>
								...
								<p className='mt-4 text-lg  text-gray-500'>
									Signup to get all the latest updates related to insurance and
									investments, right in your email.
								</p>
							</div>
						</div>

						<div className='col-span-2 text-lg lg:col-span-2 lg:flex lg:items-end'>
							<form className='w-full'>
								<div className='button email w-full md:text-lg  lg:text-xl  flex items-center h-min bg-white rounded-r-lg '>
									<input
										type='text'
										placeholder='   Enter your email'
										className='lg:w-9/12 w-8/12 h-full border p-4 appearance-none focus:appearance-none active:appearance-none  '
									/>

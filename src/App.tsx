...
function App() {
  return (
    <>
      <div className="flex flex-col lg:h-[750px]">
        <motion.div
          variants={revealParent}
          initial={"initial"}
          animate={"reveal"}
          className=" overflow-clip lg:h-full  relative flex flex-col justify-center lg:justify-between lg:items-baseline  bg-green-500"
        >
          <Blob />
...
function Navbar() {
  return (
    <motion.div
      ...
      className="navbar invisible  lg:visible  z-30 text-lg h-30 py-10 items-center px-32 lg:flex w-full justify-between"
    >
      <motion.div variants={appearAnimate} className="logo">
        logo
      </motion.div>
      <div className="links text-white gap-24 flex items-baseline justify-between">
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          variants={textParent}
          className="text-xl md:text-2xl lg:text-4xl xl:text-6xl 2xl:text-7xl items-center lg:items-start text-white flex flex-col gap-5 lg:gap-14"
        >
        ...
        <motion.div
          variants={heroReveal}
          className="button email w-full text-sm md:text-lg  lg:text-xl pl-6 flex items-center h-min bg-white rounded-r-lg "
        >
          <input
            type="text"
            placeholder="Enter your email"
            className="lg:w-9/12 w-8/12 h-full appearance-none focus:appearance-none active:appearance-none m-2 "
          />
...
function Wordings({ big, small }: { big: string; small: string }) {
  return (
    <div className="flex gap-3 items-baseline gap text-indigo-950">
      <div>
